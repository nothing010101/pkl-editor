...
export default function BlockCanvas({ reportId, page, blocks, onBlocksChange }) {
  ...
  async function handleUpload(e) {
    ...
    if (!file) return;
    const path = `${reportId}/${page.id}/${Date.now()}_${file.name}`;
  ...
  return (
    <div className="space-y-3">
      {/* Canvas putih kosong, bebas ditulis, gak ada heading dipaksa */}
      <div className="bg-white text-neutral-900 rounded-xl p-4 min-h-[500px] shadow-sm space-y-4">
